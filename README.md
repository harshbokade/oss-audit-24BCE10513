...
**VLC** — An open source media player
...
```bash
git clone https://github.com/harshbokade/oss-audit-24BCE10513.git
cd oss-audit-24BCE10513
```
...
./script4_log_analyzer.sh ~/Downloads/test.log error
...
_Submitted via the VITyarthi portal as part of The Open Source Audit Capstone Project._
